...
function GetReport() {
    ...
    $.ajax(
        {
            type: 'Get',
            url: '/Reports/GetExitJoiningReport?BUILDING_ID=' + BUILDING_ID + '&DEPT_ID=' + DEPT_ID + '&SUBDEPT_ID=' + SUBDEPT_ID + '&WF_EMP_TYPE=' + WF_EMP_TYPE + '&EMP_NAME=' + EMP_NAME + '&MONTH_ID=' + MONTH_ID + '&YEAR_ID=' + YEAR_ID + '&EMPLOYMENT_TYPE=' + EMPLOYMENT_TYPE,
            beforeSend: function () {
                ...
                function (response) {
                    var html = '';
                        if (response != "") {
                            ...
                            html += '<th class="bold" colspan=' + col +' style="text-align: center; font-size: 1.7rem; ">Workers Exit Report</th>';
                            html += '</tr>';
                            html += '<tr>'
                            ...
                            html += '<td class="bold">Exit Date</td>'
