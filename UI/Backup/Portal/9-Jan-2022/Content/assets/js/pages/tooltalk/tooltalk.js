(function () {
    ...
    Wfm.App.ToolTalk = {
        ...
        DeleteConfiguration: function () {
            ...
            var configuredItem = { ID: configId
        };
...
event.preventDefault(); return; }
            ...
            toolTalkConfiguration = JSON.stringify({ 'toolTalkConfiguration': toolTalkConfiguration
                });
...
'configuredItem': configuredItem
            ...
            var dailyCheckListItem = { ID : id, WF_ID : wfId, DATE: dailyDate, TOOL_TALK_CHECK_LIST: tool_talk_Id };
            dailyCheckListItem = JSON.stringify({
'dailyCheckListItem': dailyCheckListItem
                });
            ...
            if ($("#SUBDEPT_ID").val() === '' || $("#DEPT_ID").val() === null) {
                ...
                if ($("#WF_EMP_TYPE").val() === '' || $("#DEPT_ID").val() === null) {
            ...
            $('input:checkbox').each(function () {
                ...
                var toolTalkCheckList = { DEPT_ID : deptId, SUBDEPT_ID: subDeptId, WF_ID: wfId, DATE: checkListDate, TOOL_TALK_CHECK_LIST: tool_talk_Id };
