(function () {
    ...
    Wfm.App.WorkForce = {
        LoadAttendance: function () {
            ...
            if ($("#EMP_NAME").val() === '' && wfid !== '') {
                wfid = '';
            }

            var workforceatt = { WF_ID: wfid, DEPT_ID: deptId, MONTH_ID: monthId, YEAR_ID: yearId, SUBDEPT_ID: subDeptId, WF_EMP_TYPE: wfEmpType };
            $.ajax({
                type: "POST",
        ...
        ValidateSalDetail: function () {
            ...
            if ($('#BANK_ID option:selected').text() == 'Bank') {
