...
namespace EMailUtility
{
    class Program
    {
        ...
        static void SendMail()
        {
            ...
            try
            {
                string strmailuserid = ConfigurationManager.AppSettings["mailUser"].ToString();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        try
                        {
                            ...
                            SmtpServer.Credentials = new System.Net.NetworkCredential(strmailuserid, strmailpassword);
                            ...
                            mail.Body = dr["MAIL_CONTENT"].ToString() + "<p> Application Url :- http://karam.wfm.com</p><p></p> <p> Regards,</p><p>Karam Support Team.</p>";
